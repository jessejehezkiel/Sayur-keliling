...
public class PesanActivity extends AppCompatActivity {
    ...
    ImageView imageView, btn_orderlist, btn_alih;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_alih = findViewById(R.id.btn_alih);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                usernamepdg.setText(users.getUsername());

                if (users.getImageURL().equals("default")) {
                    imageView.setImageResource(R.mipmap.ic_launcher);
                } else {
                    Glide.with(PesanActivity.this)
                            .load(users.getImageURL())
                            .into(imageView);
                }

                bacaPesan(fuser.getUid(),userid, users.getImageURL());
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(PesanActivity.this, "Tidak ada pesan yang dikirim",
        ...
        btn_alih.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                alih();
            }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    pesanAdapter = new PesanAdapter(PesanActivity.this, mchat,imageurl);
        ...
        reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(PesanActivity.this, "Berhasil menabahkan pesanan ke order list.",
                            Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(PesanActivity.this, "Gagal menambahkan pesanan",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void alih() {
        dialogBuilder = new AlertDialog.Builder(this);
        final View alihpedagangView = getLayoutInflater().inflate(R.layout.alihpedagang, null);
    }
}
